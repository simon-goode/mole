...
Lightweight peer-to-peer file transfer tool. No cloud, no relay — files stream directly from phone to computer over your local network.
...
- If the tool detects the server may be unreachable, it prints a warning
